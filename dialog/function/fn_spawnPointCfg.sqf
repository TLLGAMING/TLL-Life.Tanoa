...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_2","TuVanaka","\a3\ui_f\data\map\MapControl\fuelstation_ca.paa"]
		];
	};
	...
	case civilian:
	{
		_return = [
			...
			["civ_spawn_2","TuVanaka","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]
		];
	...
	case independent: {
		_return = [
			...
			["medic_spawn_2","TuVanaka","\a3\ui_f\data\map\MapControl\hospital_ca.paa"]
		];
	};
};
