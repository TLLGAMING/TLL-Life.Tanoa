...
_chance = random(100);
[[2,"Royal Oak is open for business"],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
_pgText ctrlSetText format["Working at the Royal Oak, stay close (15m) (%1%2)...",round(_cP * 100),"%"];
...
[[1,format["RoyalOak", _shop, _robber, [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
_rip = false;
life_use_atm = true;
