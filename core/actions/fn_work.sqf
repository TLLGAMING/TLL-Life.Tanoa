...
_chance = random(100);
[[2,"RIBS TUNING IS OPEN FOR BUSINESS"],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
_pgText ctrlSetText format["Working at ribs tuning, stay close (15m) (%1%2)...",round(_cP * 100),"%"];
...
[[1,format["RIBS Tuning is now closed", _shop, _robber, [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
life_use_atm = true;
