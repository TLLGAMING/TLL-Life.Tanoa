...
//Button 3 - EMS Pullout/Impound
_Btn3 ctrlSetText localize "STR_vInAct_EMSPullOut";
_Btn3 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_impoundAction;";

//Button 4 - Push Vehicle
_Btn4 ctrlSetText "Push Vehicle";
_Btn4 buttonSetAction "[] spawn life_fnc_pushVehicle2; closeDialog 0;";
