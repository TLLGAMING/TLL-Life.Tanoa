...
_clothes = switch (life_clothing_store) do
{
	...
	case "Dr": {[_selection] call life_fnc_clothing_Dr;};
	case "army": {[_selection] call life_fnc_clothing_army;};
	case "Marksmen": {[_selection] call life_fnc_clothing_Marksmen;};
	case "pg": {[_selection] call life_fnc_clothing_pg;};
	case "tyreek": {[_selection] call life_fnc_clothing_tyreek;};
	case "old": {[_selection] call life_fnc_clothing_old;};
	case "fake": {[_selection] call life_fnc_clothing_fake;};
	case "Elite": {[_selection] call life_fnc_clothing_Elite;};
	case "bountyhunter": {[_selection] call life_fnc_clothing_bountyhunter;};
	case "racing": {[_selection] call life_fnc_clothing_racing;};
	case "dez": {[_selection] call life_fnc_clothing_dez;};
};
