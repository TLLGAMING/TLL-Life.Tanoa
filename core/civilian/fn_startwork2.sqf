...
titleText["Starting work at Taco Bell...","PLAIN"];
[[2,"<> Taco Bell is open for business"],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
switch(true) do
{
	...
	{
		hint format["You have successfully oompleted your shift at Taco Bell\n\nEnjoy the rest of your day",[_funds] call life_fnc_numberText];
