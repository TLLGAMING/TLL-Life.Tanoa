...
switch (_filter) do
{
	...
	{
		[
		["U_C_Poloshirt_blue","Taco Bell",250],
		["U_C_Poloshirt_redwhite","Mcdonalds",150],
		["U_C_Poloshirt_salmon","Feature",175],
		["U_C_Poloshirt_stripped","RelaimJoey",125],
		["U_C_Poloshirt_burgundy","Streamer",275],		
