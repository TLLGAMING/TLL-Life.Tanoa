/*	File: fn_copInteractionMenu.sqf	Author: Bryan "Tonic" Boardwine*/
#define Btn1 37450
#define Btn2 37451
#define Btn3 37452
#define Btn4 37453
...
if(_curTarget isKindOf "House_F") exitWith {
	if((nearestObject [[14089.54,18935.27,0],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[14083.51,18945.4,0],"Land_Research_house_V1_F"]) == _curTarget OR (nearestObject [[14083.51,18945.4,0],"Land_MilOffices_V1_F"]) == _curTarget) then {
...
_Btn8 buttonSetAction "[[],""life_fnc_removeWeaponAction"",life_pInact_curTarget,false] spawn bis_fnc_mp; closeDialog 0;";
//Breathalyser
...
//change clothes
_Btn10 ctrlSetText localize "STR_jailclothes";
_Btn10 buttonSetAction "[life_pInact_curTarget] call life_fnc_jailclothes; closeDialog 0;";
//remove comms
_Btn11 ctrlSetText localize "STR_removecomms";
_Btn11 buttonSetAction "[life_pInact_curTarget] call life_fnc_removecomms; closeDialog 0;";
